...
```
implementation("com.spotify.confidence:openfeature-provider-android:0.6.5")
```

Where `0.6.5` is the most recent version of the Provider. Released versions can be found under "Releases" within this repository.
...
```
implementation("com.spotify.confidence:confidence-sdk-android:0.6.5")
```

Where `0.6.5` is the most recent version of this SDK. 
