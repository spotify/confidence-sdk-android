...
```
implementation("com.spotify.confidence:confidence-sdk-android:0.4.1")
```

Where `0.4.1` is the most recent version of this SDK. 
...
```
implementation("com.spotify.confidence:openfeature-provider-android:0.4.1")
```

Where `0.4.1` is the most recent version of the Provider. Released versions can be found under "Releases" within this repository.
<!---x-release-please-end-->
